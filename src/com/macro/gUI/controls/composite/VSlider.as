package com.macro.gUI.controls.composite
{
	...
	public class VSlider extends AbstractComposite implements IKeyboard, IDrag, IButton
	{
		...
		override public function resize(width:int = 0, height:int = 0):void
		{
			if (_autoSize)
			{
				var min:int = _margin.top + _margin.bottom;
		...
		override protected function layout():void
		{
			...
			_bg.y = _margin.top - _bg.skin.gridTop;
			_bg.height = _rect.height - _margin.bottom + _bg.skin.marginBottom - _bg.y;

			_minY = _margin.top - _blockBtn.normalSkin.gridTop;
			_maxY = _rect.height - _margin.bottom - _blockBtn.normalSkin.gridTop;
