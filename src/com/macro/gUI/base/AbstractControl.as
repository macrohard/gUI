	...
	public class AbstractControl extends EventDispatcher implements IControl
	{
		...
		protected function paint(rebuild:Boolean = false):void
		{
			...
			if (_skin != null && _skin.bitmapData != null)
			{
				if (_skin.gridRight > _skin.gridLeft)
				{
					...
					{
						_skinDrawRect = drawHorizontal(_bitmapData, _rect,
													   _skin);
					}
				}
				else
				{
					...
					{
						_skinDrawRect = drawFixed(_bitmapData, _rect,
												  _skin.align, _skin.bitmapData);
					}
				}
			}
										   ...
										   skin:ISkin):Rectangle
		{
			...
			canvas.copyPixels(skin.bitmapData,
							  new Rectangle(0, 0, skin.gridLeft, skin.gridTop),
							  new Point(0, 0), null, null, true);
			canvas.copyPixels(skin.bitmapData,
							  new Rectangle(skin.gridRight, 0,
											skin.paddingRight, skin.gridTop),
							  new Point(rect.width - skin.paddingRight, 0),
							  null, null, true);
			canvas.copyPixels(skin.bitmapData,
							  new Rectangle(0, skin.gridBottom, skin.gridLeft,
											skin.paddingBottom),
							  new Point(0, rect.height - skin.paddingBottom),
							  null, null, true);
			canvas.copyPixels(skin.bitmapData,
							  new Rectangle(skin.gridRight, skin.gridBottom,
											skin.paddingRight, skin.paddingBottom),
							  new Point(rect.width - skin.paddingRight,
										rect.height - skin.paddingBottom), null,
							  null, true);
			...
			canvas.draw(skin.bitmapData, matrix, null, null,
						new Rectangle(skin.gridLeft, 0, scaleW, skin.gridTop),
						smoothing);

			matrix.translate(0, rect.height - skin.bitmapData.height);
			canvas.draw(skin.bitmapData, matrix, null, null,
						new Rectangle(skin.gridLeft,
									  rect.height - skin.paddingBottom, scaleW,
									  skin.paddingBottom), smoothing);
			...
			canvas.draw(skin.bitmapData, matrix, null, null,
						new Rectangle(0, skin.gridTop, skin.gridLeft, scaleH),
						smoothing);

			matrix.translate(rect.width - skin.bitmapData.width, 0);
			canvas.draw(skin.bitmapData, matrix, null, null,
						new Rectangle(rect.width - skin.paddingRight,
									  skin.gridTop, skin.paddingRight, scaleH),
						smoothing);

			//绘制中心
			matrix = new Matrix();
			matrix.scale(scaleX, scaleY);
			matrix.translate(skin.gridLeft * (1 - scaleX),
							 skin.gridTop * (1 - scaleY));
			canvas.draw(skin.bitmapData, matrix, null, null,
						new Rectangle(skin.gridLeft, skin.gridTop, scaleW, scaleH),
						smoothing);
											   ...
											   skin:ISkin):Rectangle
		{
			...
			//绘制上、下端
			canvas.copyPixels(skin.bitmapData,
							  new Rectangle(0, 0, skin.bitmapData.width,
											skin.gridTop), new Point(ox, 0),
							  null, null, true);
			canvas.copyPixels(skin.bitmapData,
							  new Rectangle(0, skin.gridBottom,
											skin.bitmapData.width,
											skin.paddingBottom),
							  new Point(ox, rect.height - skin.paddingBottom),
							  null, null, true);
			...
			canvas.draw(skin.bitmapData, matrix, null, null,
						new Rectangle(ox, skin.gridTop, skin.bitmapData.width,
									  scaleH), smoothing);
												 ...
												 skin:ISkin):Rectangle
		{
			...
			//绘制左、右端
			canvas.copyPixels(skin.bitmapData,
							  new Rectangle(0, 0, skin.gridLeft,
											skin.bitmapData.height),
							  new Point(0, oy), null, null, true);
			canvas.copyPixels(skin.bitmapData,
							  new Rectangle(skin.gridRight, 0,
											skin.paddingRight,
											skin.bitmapData.height),
							  new Point(rect.width - skin.paddingRight, oy),
							  null, null, true);
			...
			canvas.draw(skin.bitmapData, matrix, null, null,
						new Rectangle(skin.gridLeft, oy, scaleW,
									  skin.bitmapData.height), smoothing);
											...
											padding:Margin = null):Rectangle
		{
			...
			var t:Rectangle = new Rectangle(ox, oy, bitmapData.width,
											bitmapData.height);
			t = r.intersection(t);

			canvas.copyPixels(bitmapData,
							  new Rectangle(t.x - ox, t.y - oy, t.width, t.height),
							  new Point(t.x, t.y), null, null, true);
